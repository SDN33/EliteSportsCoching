        ...
        <div className="mb-10 sm:mb-16 flex flex-wrap justify-center gap-2 sm:gap-3 md:gap-4">
          {values.map((value, index) => (
            <span
              ...
              className="group relative overflow-hidden rounded-full border border-white/20 bg-gradient-to-r from-white/5 to-white/[0.02] backdrop-blur-lg px-3 sm:px-5 py-2 sm:py-2.5 text-xs sm:text-sm font-bold text-white/90 hover:border-blue-500/50 hover:bg-white/10 transition-all duration-300 cursor-default"
            >
        ...
        <div className="grid gap-4 sm:gap-6 md:grid-cols-2 lg:grid-cols-3">
          {valuePillars.map(({ icon: Icon, title, text }, index) => (
            ...
            >
              ...
              {/* Icon */}
              <div className="mb-4 sm:mb-6 inline-flex rounded-lg border border-blue-500/30 bg-blue-500/10 p-3 text-blue-400 group-hover:border-blue-400/60 group-hover:bg-blue-500/20 group-hover:scale-110 transition-all duration-300">
