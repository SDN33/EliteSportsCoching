...
export const SponsorsSection = () => {
  return (
    <section id="identite" className="relative py-14 sm:py-20 md:py-32 overflow-hidden">
      {/* Background elements */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-96 h-96 bg-gradient-to-b from-white/5 to-transparent rounded-full blur-3xl -z-10" />
      ...
      <div className="container">
        <div data-reveal className="space-y-12">
          ...
          <article
            data-reveal
            data-reveal-delay="3"
            className="relative mx-auto w-full max-w-5xl rounded-3xl overflow-hidden border border-white/20 bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl shadow-2xl hover:shadow-3xl transition-all duration-500 hover:border-white/30 group"
          >
            {/* Image Container */}
