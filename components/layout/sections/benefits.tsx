    ...
    <section id="presentation" className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="container">
        <div className="grid gap-12 lg:grid-cols-[1.1fr_0.9fr] lg:gap-16">
          {/* Left Content */}
          <div data-reveal="left" className="flex flex-col gap-8 items-center lg:items-start">
            <div className="space-y-4 text-center lg:text-left w-full">
              ...
              <h2 className="font-title text-4xl md:text-6xl font-bold leading-tight text-foreground text-balance-pretty">
                Eddy Saint-Cyr
            ...
            <div className="space-y-6">
              ...
              <div className="text-base leading-relaxed text-orange-400 font-semibold p-4 rounded-lg border border-orange-500/30 bg-orange-500/10 flex items-start gap-3">
